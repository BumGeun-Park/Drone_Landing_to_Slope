...
public:
	SubscribeAndPublish()
	{
	pub_ = n_.advertise<rplidar_data::alpha>("/Kp_error3",1);
	sub_ = n_.subscribe("/error3",1,&SubscribeAndPublish::callback,this);
	}
...
int main(int argc, char **argv)
{
    ...
    printf("\n");
    printf("\x1b[37m""*****proportional_controller3*****\n""\x1b[0m");
    ros::init(argc, argv, "proportional_controller3");
