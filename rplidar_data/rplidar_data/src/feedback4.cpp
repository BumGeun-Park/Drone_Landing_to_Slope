...
public:
	SubscribeAndPublish()
	{
	pub_ = n_.advertise<rplidar_data::alpha>("/error4",1);
	sub_1 = n_.subscribe("/dist4",1,&SubscribeAndPublish::callback1,this);
	sub_2 = n_.subscribe("/avg_z",1,&SubscribeAndPublish::callback2,this);
	}
	
	void callback1(const rplidar_data::alpha& dist4)
	{
	  Dist = dist4.alpha;
...
int main(int argc, char **argv)
{
    ...
    printf("\n");
    printf("\x1b[37m""*****feedback4 node*****\n""\x1b[0m");
    ros::init(argc, argv, "feedback4");
