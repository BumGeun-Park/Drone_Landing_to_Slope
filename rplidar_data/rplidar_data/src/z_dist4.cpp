...
public:
	SubscribeAndPublish()
	{
	pub_ = n_.advertise<rplidar_data::alpha>("/dist4",1);
	sub_1 = n_.subscribe("/Ground4_z",1,&SubscribeAndPublish::callback1,this);
	sub_2 = n_.subscribe("/Leg4_z",1,&SubscribeAndPublish::callback2,this);
	}
	
	void callback1(const rplidar_data::alpha& Ground)
	{
	  Ground4_z = Ground.alpha;
	  z.alpha = Ground4_z - Leg4_z;
	  pub_.publish(z);	
	}
...
int main(int argc, char **argv)
{
    ...
    printf("\n");
    printf("\x1b[37m""*****z_dist4 node*****\n""\x1b[0m");
    ros::init(argc, argv, "z_dist4");
