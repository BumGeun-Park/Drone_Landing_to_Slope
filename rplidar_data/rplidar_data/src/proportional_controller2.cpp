...
public:
	SubscribeAndPublish()
	{
	pub_ = n_.advertise<rplidar_data::alpha>("/Kp_error2",1);
	sub_ = n_.subscribe("/error2",1,&SubscribeAndPublish::callback,this);
	}
...
int main(int argc, char **argv)
{
    ...
    printf("\n");
    printf("\x1b[37m""*****proportional_controller2*****\n""\x1b[0m");
    ros::init(argc, argv, "proportional_controller2");
